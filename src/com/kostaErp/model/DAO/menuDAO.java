...
public class menuDAO {
    ...
    //8. 메뉴 판매 시, 해당 메뉴에 포함된 식자재 재고를 자동으로 차감 업데이트
	...
	//9. 특정 사업자가 등록한 메뉴 카테고리 목록 조회 - 메뉴 카테고리에 bId가 있음
	...
	//10. 카테고리 삭제 전, 해당 카테고리를 사용 중인 메뉴가 있는지 확인 -> null값 들어가면 안됨(추가)
	...
	//12. 카테고리 명칭을 통해 해당 카테고리의 고유 ID 조회
